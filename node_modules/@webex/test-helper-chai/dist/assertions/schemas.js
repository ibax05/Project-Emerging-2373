...
module.exports = function schemas(chai) {
  ...
  Assertion.addProperty('AccessToken', function () {
    assert.properties(this._obj, ['access_token', 'token_type', 'expires', 'expires_in', 'refresh_token', 'refresh_token_expires', 'refresh_token_expires_in']);
  });
  ...
  Assertion.addProperty('Membership', function () {
    assert.properties(this._obj, ['id', 'roomId', 'personId', 'personEmail', 'isModerator', 'isMonitor', 'created']);
  ...
  Assertion.addProperty('TeamMembership', function () {
    assert.properties(this._obj, ['id', 'teamId', 'personId', 'personEmail', 'isModerator', 'created']);
    assert.isHydraID(this._obj.id);
