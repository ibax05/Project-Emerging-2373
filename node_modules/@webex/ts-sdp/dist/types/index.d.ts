...
declare const NUM = "\\d+";
declare const TOKEN = "\\S+";
declare const SP = "\\s";
declare const WS = "\\w*";
declare const REST = ".+";

export { ApplicationMediaDescription, AvMediaDescription, BandwidthLine, BandwidthType, BundleGroupLine, CandidateLine, CodecInfo, ConnectionLine, ContentLine, DefaultSdpGrammar, DirectionLine, ExtMapLine, FingerprintLine, FmtpLine, Grammar, IceInfo, IceOptionsLine, IcePwdLine, IceUfragLine, Line, MaxMessageSizeLine, MediaDescription, MediaDirection, MediaLine, MediaType, MidLine, NUM, OriginLine, REST, RidLine, RtcpFbLine, RtcpMuxLine, RtpMapLine, SP, SctpPortLine, Sdp, SdpBlock, SessionDescription, SessionInformationLine, SessionNameLine, Setup, SetupLine, SimulcastLayer, SimulcastLayerList, SimulcastLine, TOKEN, TimingLine, VersionLine, WS, disableRemb, disableRtcpFbValue, parse, parseToLines, parseToModel, removeCodec };
